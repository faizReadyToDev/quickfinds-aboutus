            ...
            <div className="bg-[#D1FFD1]">
                ...
                <div className="">
                    ...
                    <p className="font-poppins md:w-[30vw] xl:text-base lg:text-sm sm:text-xs xs:w-[70vw] xs:text-center xs:text-[12px]">
                        ...
                        <span className="">
                            <button className="bg-[#51B504] text-[#FFFFFF] lg:pt-[20px] lg:pr-[30px] lg:pb-[20px] lg:pl-[30px] lg:rounded-[16px] lg:text-lg lg:mt-[10px] xs:mt-[7px] font-bold sm:pt-[2px] sm:pb-[2px] sm:pr-[10px] sm:pl-[10px] sm:rounded-[5px] sm:text-[12px] xs:text-[12px] xs:pt-[2px] xs:pb-[2px] xs:pr-[10px] xs:pl-[10px] xs:rounded-[5px] xs:font-[400]">Get Started</button>
                ...
                <div className="logo-animation bg-white lg:pt-[30px] lg:pb-[30px] overflow-hidden xs:mt-[10px] xs:pt-[0px] xs:pb-[0px] sm:pt-[15px] sm:pb-[15px]">
                    <div className="logo-slide flex items-center  gap-[30px] whitespace-nowrap lg:h-[10vh] md:h-[5vh] xs: h-[7vh]">
                        ...
                        <span className="lg:text-3xl xs:text-lg sm:text-xl font-bold mr-[40px]">We Make Solutions Simple</span> <span className="lg:text-3xl xs:text-lg font-bold mr-[40px] sm:text-xl">True Design is Invisible</span>
                        <div className="flex items-center relative mr-[40px]">
                            <img  src="assets/img/Logo.png" alt="" />
                            <span className="font-poppins lg:text-3xl xs:text-lg sm:text-xl font-bold leading-[30px] text-left" style={{ color: 'rgb(2, 46, 80)' }}>Quick</span >
                            <span className="text-[#51B504] font-poppins lg:text-3xl xs:text-lg sm:text-xl font-bold leading-[30px] mr-[40px] text-left">Finds</span>
